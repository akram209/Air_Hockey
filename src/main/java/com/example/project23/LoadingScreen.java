...
import static com.example.project23.Game.Height;
import static com.example.project23.Game.Width;
...
public class LoadingScreen extends BorderPane {
    ...
    LoadingScreen() {
        ...
        loadingAnimation = new Timeline(new KeyFrame(Duration.millis(5), e -> {
            loadingBar.setProgress(loadingP);
            loadingP += .005;
        })
        );

        loadingAnimation.setCycleCount(200);
        HBox hbox = new HBox();
